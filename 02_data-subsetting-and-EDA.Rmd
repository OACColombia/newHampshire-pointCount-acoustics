...
data |> 
  ...
  ggplot(aes(x = start_time, y = abundance)) + 
  geom_segment(aes(y = 0, yend = abundance), color = "gray") + 
  geom_point() + 
...
data |> 
  mutate(start_time = hms::as_hms(start_time)) |> 
  ggplot(aes(x = start_time, y = detections)) + 
  geom_segment(aes(y = 0, yend = detections), color = "gray") + 
  geom_point() + 
